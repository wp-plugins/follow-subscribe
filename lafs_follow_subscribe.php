...
/*
 ...
 Plugin URI: http://www.linksalpha.com/widgets/fs
 Author: LinksAlpha.com
 Author URI: http://www.linksalpha.com
 Description: Follow and Subscribe is a siderbar widget that shows links to Facebook, Google Plus, Twitter, linkedIn, Pinterest, Xing, StumbleUpon, YouTube, About.me, foursquare...   
 Version: 1.0
 */
...
$lafs_options_language = array(
    'la_opt_lang_googleplus'			=> array('option_name'=>'la-html-widget-lang-googleplus', 	'default_value'=>'en-US', 		'type'=>'string',	'field_name'=>__('GooglePlus language options'),		'param_name'=>'gpluslang'),
...
$la_options_widget_color = array(
	...
	'la_opt_fs_color_row2'		=>	array('option_name'=>'la-html-fs-color-row2',		'default_value'=>'#F5FCFE',		'default_update'=> true,		'type'=>'string',		'field_type'=>'text',			'field_name'=>__('Background color for GooglePlus'),	'param_name'=>'row2',																			 ),
	...
	'la_opt_fs_size'		    =>	array('option_name'=>'la-html-fs-size',				'default_value'=>250,		 	'default_update'=> true,		'type'=>'integer',		'field_type'=>'select',			'field_name'=>__('Width of the Widget'),				'param_name'=>'width',		'field_options'=>array(200, 250, 300, 336)							 ),
...
function lafs_write_database($option){
	if($option == 'default'){
		...
		if(isset($_POST['lafs_options_main'])){
			global $lafs_options_main;
			foreach($lafs_options_main as $key=>$value){
				$this_val=trim($_POST[$value['option_name']]);
				if($this_val!=''){
...
function lafs_widget_function(){
	...
	$lafs_opt_widget=lafs_opt($data,$data_div);
